...
- `src/components/editor/SheetsBar.ts`:
  - Меню «Штамп» содержит поля: Стадия, Дата, Утвердил, Н. контр., ГИП, Проверил, Согласовал, Разработал.
  - Поле **Стадия** отрисовывается справа от 70 мм поля, в объединённых строках 4–5, по центру правой части (50×10 мм).
