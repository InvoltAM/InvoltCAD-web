...
Последний коммит: `d6b0194` — `feat: add sheet number and total inputs to sheet menu, render in stamp`.
...
- Dev-сервер запускался на `http://localhost:3002/editor` и проверялся в браузере (Playwright).
