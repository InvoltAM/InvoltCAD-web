...
- Страницы списков и форм: ~~`/crm/clients`, `/crm/clients/new`, `/crm/leads`, `/crm/leads/new`~~ (готово).
- Страницы редактирования `/crm/clients/[id]`, `/crm/leads/[id]`.
...
1. Добавить страницы редактирования клиентов и лидов (`/crm/clients/[id]`, `/crm/leads/[id]`).
2. Добавить API и страницы для сделок (`/api/crm/deals`, `/crm/deals`).
3. Добавить API и страницы для задач (`/api/crm/tasks`, `/crm/tasks`).
