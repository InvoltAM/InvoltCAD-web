...
Последний коммит: `refactor(sheet-frame): штамп по ГОСТ Р 21.101-2020 форма 3, как на скриншоте`.

## Что сделано в этой сессии

### Отрисовка штампа один в один со скриншотом ГОСТ Р 21.101-2020, форма 3
