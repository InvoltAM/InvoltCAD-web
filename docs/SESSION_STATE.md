...
1. Развитие CRM: шаблоны email, массовые рассылки, воронка продаж, напоминания по задачам.
2. Улучшение связи документов/КП/счетов со сделкой: редактирование, публикация КП, отправка счёта email.
