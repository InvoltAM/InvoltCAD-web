...
- Проверено вручную: развёртывание панели «Слои» сдвигает все нижестоящие панели вниз, сохраняя столбик; сворачивание возвращает их обратно. Никакая панель не уходит в `left: 0`.
