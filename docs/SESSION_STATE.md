...
- `TrimTool` обрезает отрезок/сегмент полилинии до ближайшего пересечения со стеной или другим примитивом. Исправлено направление луча: обрезка идёт от обрезаемого конца внутрь сегмента.
