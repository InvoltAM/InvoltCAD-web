...
- Углублённая интеграция CRM-проекты: автосоздание сделки из проекта, КП, счета из сделки и т.п.

### Email-рассылки и платежи по сделкам
...
- Расширена схема Prisma:
  ...
  - `CrmDeal` получила связи `emails` и `payments`.
...
1. Углублённая интеграция CRM ↔ проекты: автосоздание сделки из проекта, генерация КП/счёта из сделки, связь документов со сделкой.
