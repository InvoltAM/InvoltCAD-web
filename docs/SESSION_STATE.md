...
- API для Telegram-логов (`/api/crm/telegram`).
...
1. Добавить API Telegram-логов и базовую страницу для работы с Telegram в лидах/клиентах.
2. Начать интеграцию CRM с проектами InvoltCAD (связь сделок с проектами, клиентов с проектами).
