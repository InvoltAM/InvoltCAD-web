...
- Страницы сделок и задач (`/crm/deals`, `/crm/tasks`).
...
1. Добавить API и страницы для сделок (`/api/crm/deals`, `/crm/deals`).
2. Добавить API и страницы для задач (`/api/crm/tasks`, `/crm/tasks`).
